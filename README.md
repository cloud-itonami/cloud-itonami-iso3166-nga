# cloud-itonami-iso3166-nga

Open ISO 3166 Blueprint for **NGA**: Nigeria.
...
tax registration, and local-content rules in Nigeria, so the operator
...
- **Not the government of Nigeria.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Nigerian-licensed counsel
...
(ISO 3166 `NGA`). Required capabilities:
