...
2. Register the client's intake: business type, target public function,
   prior filing history in Nigeria if any.
3. Run the advisor in read-only mode against the Nigeria Open Contracting Portal (NOCOPO), overseen by the Bureau of Public Procurement (BPP).
...
- named referral relationship with Nigerian-licensed counsel or a
...
a working referral relationship with Nigerian-licensed counsel or a
registered agent for whatever licensed representation the law of
Nigeria requires for actual public-procurement filings.
